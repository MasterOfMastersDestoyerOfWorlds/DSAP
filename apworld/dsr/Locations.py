...
"Upper Undead Burg - Undead Merchant Male": [
    DSRLocationData(11110716, f"SHOP: Orange Soapstone", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110721, f"SHOP: Residence Key", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110722, f"SHOP: Repair Box", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110748, f"SHOP: Bottomless Box", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Upper Undead Burg - Undead Merchant Female": [
    DSRLocationData(11110756, f"SHOP: Transient Curse", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110760, f"SHOP: Hummanity", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Sen's Fortress - Crestfallen Merchant": [
    DSRLocationData(11110775, f"SHOP: Thunder Stoneplate Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110776, f"SHOP: Spell Stoneplate Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Undead Parish - Andre": [
    DSRLocationData(11110800, f"SHOP: Crest of Artorias", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110801, f"SHOP: Weapon Smithbox", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110802, f"SHOP: Armor Smithbox", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110803, f"SHOP: Repair Box", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Domhnall of Zena": [
    DSRLocationData(11110820, f"SHOP: Gold Pine Resin", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110835, f"SHOP: Golem Helm", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110836, f"SHOP: Golem Armor", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110837, f"SHOP: Golem Gauntlets", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110838, f"SHOP: Golem Leggings", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110839, f"SHOP: Smough's Helm", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110840, f"SHOP: Smough's Armor", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110841, f"SHOP: Smough's Gauntlets", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110842, f"SHOP: Smough's Leggings", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110843, f"SHOP: Ornstein's Helm", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110844, f"SHOP: Ornstein's Armor", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110845, f"SHOP: Ornstein's Gauntlets", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110846, f"SHOP: Ornstein's Leggings", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110847, f"SHOP: Crown of the Dark Sun", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110848, f"SHOP: Moonlight Robe", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110849, f"SHOP: Moonlight Gloves", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110850, f"SHOP: Moonlight Waistcloth", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110851, f"SHOP: Crown of the Great Lord", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110852, f"SHOP: Robe of the Great Lord", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110853, f"SHOP: Bracelet of the Great Lord", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110854, f"SHOP: Anklet of the Great Lord", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110855, f"SHOP: Master Key", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110856, f"SHOP: Helm of Artorias", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110857, f"SHOP: Armor of Artorias", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110858, f"SHOP: Gauntlets of Artorias", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
    DSRLocationData(11110859, f"SHOP: Leggings of Artorias", f"Firebomb", DSRLocationCategory.BOSS_SOUL_TRANSMUTATION),
],
"Catacombs - Patches": [
    DSRLocationData(11110860, f"SHOP: Eye of Death", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110861, f"SHOP: Divine Blessing", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110863, f"SHOP: Humanity", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110864, f"SHOP: Twin Humanities", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110865, f"SHOP: Miracle: Heal", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110866, f"SHOP: Great Heal Excerpt", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110867, f"SHOP: Crescent Axe", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Blighttown - Shiva of the East": [
    DSRLocationData(11110878, f"SHOP: East Wood Grain Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Griggs of Vinheim": [
    DSRLocationData(11110888, f"SHOP: Sorcery: Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110889, f"SHOP: Sorcery: Great Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110890, f"SHOP: Sorcery: Heavy Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110891, f"SHOP: Sorcery: Great Heavy Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110892, f"SHOP: Magic Weapon", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110893, f"SHOP: Magic Shield", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110894, f"SHOP: Sorcery: Aural Decoy", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110895, f"SHOP: Sorcery: Fall Control", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110896, f"SHOP: Bellowing Dragoncrest Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110897, f"SHOP: Lingering Dragoncrest Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Oolacile Sanctuary - Elizabeth": [
    DSRLocationData(11110904, f"SHOP: Sorcery: Hidden Weapon", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110905, f"SHOP: Sorcery: Hidden Body", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110906, f"SHOP: Cast Light", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110907, f"SHOP: Sorcery: Repair", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110908, f"SHOP: Sorcery: Chameleon", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"New Londo Ruins - Ingward": [
    DSRLocationData(11110910, f"SHOP: Sorcery: Resist Curse", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Laurentius of the Great Swamp": [
    DSRLocationData(11110912, f"SHOP: Pyromancy: Fireball", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110913, f"SHOP: Fire Orb", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110914, f"SHOP: Pyromancy: Combustion", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110915, f"SHOP: Iron Flesh", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110916, f"SHOP: Pyromancy: Flash Sweat", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Quelagg's Domain - Egg Merchant": [
    DSRLocationData(11110917, f"SHOP: Servant Roster", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Blighttown - Quelana of Izalith": [
    DSRLocationData(11110919, f"SHOP: Pyromancy: Poison Mist", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110920, f"SHOP: Pyromancy: Toxic Mist", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110921, f"SHOP: Fire Orb", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110922, f"SHOP: Pyromancy: Combustion", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110923, f"SHOP: Pyromancy: Great Fireball", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110924, f"SHOP: Pyromancy: Firestorm", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110925, f"SHOP: Pyromancy: Fire Whip", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110927, f"SHOP: Great Combustion", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110928, f"SHOP: Pyromancy: Undead Rapport", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Reah of Thorolund": [
    DSRLocationData(11110929, f"SHOP: Miracle: Heal", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110930, f"SHOP: Great Heal Excerpt", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110931, f"SHOP: Homeward", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110932, f"SHOP: Miracle: Force", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110933, f"SHOP: Seek Guidance", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110936, f"SHOP: Divine Blessing", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110938, f"SHOP: Miracle: Great Heal", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110940, f"SHOP: Homeward", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110941, f"SHOP: Miracle: Force", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110942, f"SHOP: Miracle: Wrath of the Gods", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110943, f"SHOP: Seek Guidance", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110944, f"SHOP: Miracle: Magic Barrier", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Undead Parish - Oswald of Carim": [
    DSRLocationData(11110763, f"SHOP: Purging Stone", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110946, f"SHOP: Book of the Guilty", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110949, f"SHOP: Miracle: Karmic Justice", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110951, f"SHOP: Bloodbite Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110952, f"SHOP: Poisonbite Ring", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110953, f"SHOP: Ring of Sacrifice", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Big Hat Logan": [
    DSRLocationData(11110955, f"SHOP: Sorcery: Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110956, f"SHOP: Sorcery: Great Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110957, f"SHOP: Sorcery: Heavy Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110958, f"SHOP: Sorcery: Great Heavy Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110959, f"SHOP: Sorcery: Homing Soulmass", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110960, f"SHOP: Soul Spear", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110961, f"SHOP: Magic Weapon", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110962, f"SHOP: Magic Shield", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110963, f"SHOP: Sorcery: Homing Crystal Soulmass", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110964, f"SHOP: Sorcery: Crystal Soul Spear", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110965, f"SHOP: Sorcery: Crystal Magic Weapon", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Firelink Shrine - Big Hat Logan": [
    DSRLocationData(11110899, f"SHOP: Sorcery: Homing Soulmass", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110900, f"SHOP: Soul Spear", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"New Londo Ruins - Rickert of Vinheim": [
    DSRLocationData(11110901, f"SHOP: Sorcery: Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110902, f"SHOP: Sorcery: Heavy Soul Arrow", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Oolacile Township - Gough": [ 
    DSRLocationData(11111028, f"SHOP: Hello Carving", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111029, f"SHOP: Thank you Carving", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Unknown Merchant": [
    DSRLocationData(11111010, f"SHOP: Humanity", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111018, f"SHOP: Gold Pine Resin", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111058, f"SHOP: Pyromancy: Fireball", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111077, f"SHOP: Miracle: Heal", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111079, f"SHOP: Great Heal Excerpt", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11111078, f"SHOP: Mystery Shop Flag", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
],
"Merchant Consumables": [
