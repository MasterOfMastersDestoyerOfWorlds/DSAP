...
"Upper Undead Burg - Undead Merchant": [
    ...
    DSRLocationData(11110835, f"SHOP: Golem Helm", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110836, f"SHOP: Golem Armor", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110837, f"SHOP: Golem Gauntlets", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110838, f"SHOP: Golem Leggings", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110839, f"SHOP: Smough's Helm", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110840, f"SHOP: Smough's Armor", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110841, f"SHOP: Smough's Gauntlets", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110842, f"SHOP: Smough's Leggings", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110843, f"SHOP: Ornstein's Helm", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110844, f"SHOP: Ornstein's Armor", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110845, f"SHOP: Ornstein's Gauntlets", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110846, f"SHOP: Ornstein's Leggings", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110847, f"SHOP: Crown of the Dark Sun", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110848, f"SHOP: Moonlight Robe", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110849, f"SHOP: Moonlight Gloves", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110850, f"SHOP: Moonlight Waistcloth", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110851, f"SHOP: Crown of the Great Lord", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110852, f"SHOP: Robe of the Great Lord", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110853, f"SHOP: Bracelet of the Great Lord", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110854, f"SHOP: Anklet of the Great Lord", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110855, f"SHOP: Master Key", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110856, f"SHOP: Helm of Artorias", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110857, f"SHOP: Armor of Artorias", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110858, f"SHOP: Gauntlets of Artorias", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
    DSRLocationData(11110859, f"SHOP: Leggings of Artorias", f"Firebomb", DSRLocationCategory.SHOP_LINE_UP_KEY),
